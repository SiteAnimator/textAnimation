...
foreach ( $textArray as $key => $value ) {
    ...
    echo '{';
        ...
        echo '"items" : {';
            ...
            echo '},';
            echo '"portretWidth" : {';
                echo '"path" : "' . $lineOptions['portretWidth'] . '"';
            echo '},';
            echo '"portretHeight" : {';
                echo '"path" : "' . $lineOptions['portretHeight'] . '"';
            echo '},';
            echo '"portretLeft" : {';
                echo '"path" : "' . $lineOptions['portretLeft'] . '"';
            echo '},';
            echo '"portretTop" : {';
                echo '"path" : "' . $lineOptions['portretTop'] . '"';
            echo '},';
            echo '"opacity" : {';
    ...
    echo '{';
        ...
        echo '"items" : {';
            ...
            echo '},';
            echo '"portretWidth" : {';
                echo '"path" : "' . $textOptions['portretWidth'] . '"';
            echo '},';
            echo '"portretHeight" : {';
                echo '"path" : "' . $textOptions['portretHeight'] . '"';
            echo '},';
            echo '"portretLeft" : {';
                echo '"path" : "' . $textOptions['portretLeft'] . '"';
            echo '},';
            echo '"portretTop" : {';
                echo '"path" : "' . $textOptions['portretTop'] . '"';
            echo '},';
            echo '"opacity" : {';
