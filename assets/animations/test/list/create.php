...
foreach ( $list as $item => $options ) {
    ...
    echo '{';
        ...
        echo '"items" : {';
            ...
            echo '},';
            echo '"portretWidth" : {';
                echo '"path" : "' . $options['point']['portretWidth'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretHeight" : {';
                echo '"path" : "' . $options['point']['portretHeight'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretLeft" : {';
                echo '"path" : "' . $options['point']['portretLeft'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretTop" : {';
                echo '"path" : "' . $options['point']['portretTop'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"rotate" : {';
                echo '"path" : "360,0",';
    ...
    echo '{';
        ...
        echo '"items" : {';
            ...
            echo '},';
            echo '"portretWidth" : {';
                echo '"path" : "' . $options['text']['portretWidth'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretHeight" : {';
                echo '"path" : "' . $options['text']['portretHeight'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretLeft" : {';
                echo '"path" : "' . $options['text']['portretLeft'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"portretTop" : {';
                echo '"path" : "' . $options['text']['portretTop'] . '",';
                echo '"effect" : "inBack"';
            echo '},';
            echo '"opacity" : {';
                echo '"path" : "0.4,1"';
